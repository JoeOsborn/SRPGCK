...
void main ()
{
  ...
  highp vec4 boxTex;
  highp vec3 tmpvar_6;
  tmpvar_6 = ((floor (((xlv_TEXCOORD1 - _MapWorldOrigin.xyz) / _MapTileSize.xyz)) + vec3(0.0, 1.0, 0.0)).xzy / _MapSizeInTiles.xzy);
  lowp vec4 tmpvar_7;
...
MUL R0.x, R0, R0.z;
CMP R0.x, -R0, c[6].y, c[6];
SLT R0.y, c[6].z, fragment.texcoord[0];
MUL R0.y, R0.x, R0;
MUL R0.y, R0, R1.x;
MOV R0.x, c[6].y;
...
MAX R1.w, R1, c[6].y;
MUL R0.xyz, R1.w, R0;
MAD result.color.xyz, R0, c[6].w, R1;
...
; 51 ALU, 1 TEX
dcl_2d s0
def c6, 0.00000000, 1.00000000, 0.30000001, 2.00000000
dcl t0.xy
dcl t1.xyz
dcl t2.xyz
dcl t3.xyz
...
MUL R0.x, R0, R0.z;
CMP R0.x, -R0, c[4].y, c[4];
SLT R0.y, c[4].z, fragment.texcoord[0];
MUL R0.y, R0.x, R0;
MOV R0.x, c[4].y;
MUL R0.y, R0, R2.x;
...
dcl_2d s0
dcl_2d s1
def c4, 0.00000000, 1.00000000, 0.30000001, 8.00000000
dcl t0.xy
dcl t1.xyz
dcl t2.xy
texld r3, t2, s1
...
mul_pp r1.x, r1, r4
cmp r2.x, r2, c4, c4.y
cmp_pp r1.x, -r1, c4.y, c4
mul_pp r1.x, r1, r2
mul_pp r0.x, r1, r0
mov_pp r1, c3
cmp_pp r0, -r0.x, c4.x, r1
...
SLT R0.y, c[5].z, fragment.texcoord[0];
CMP R0.x, -R0, c[5].y, c[5];
MUL R0.x, R0, R0.y;
MUL R0.y, R0.x, R1.x;
RSQ R0.z, R0.z;
...
dcl_2d s0
dcl_2d s1
def c5, 0.00000000, 1.00000000, 0.30000001, 2.00000000
dcl t0.xy
dcl t1.xyz
dcl t2.xyz
dcl t3.xyz
...
mul_pp r1.x, r1, r3
cmp r2.x, r2, c5, c5.y
cmp_pp r1.x, -r1, c5.y, c5
mul_pp r1.x, r1, r2
mul_pp r1.x, r1, r0
dp3_pp r0.x, t3, t3
mov_pp r2, c4
cmp_pp r1, -r1.x, c5.x, r2
rsq_pp r0.x, r0.x
...
RCP R0.z, c[3].y;
MUL R1.xyz, R1.xzyw, R0;
MAD R0.xy, fragment.texcoord[4], R0.w, c[5].w;
...
MUL R0.y, R0, R1.x;
SLT R0.z, c[5], fragment.texcoord[0].y;
CMP R0.y, -R0, c[5], c[5].x;
MUL R0.y, R0, R0.z;
MUL R0.y, R0, R0.x;
MOV R0.x, c[5].y;
...
dcl_2d s1
dcl_2d s2
def c5, 0.00000000, 1.00000000, 0.30000001, 0.50000000
